...
async def regenerate_report_with_actions(
    ...
    system_prompt = (
        ...
        "8. The report is the radiologist's own voice — do NOT cite sources, name societies, "
        "or quote guidelines in the revised text. If an action's details reference a source, "
        "use the substance as clinical judgement; never carry the attribution into the report.\n\n"
